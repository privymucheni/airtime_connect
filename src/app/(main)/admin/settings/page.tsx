    ...
    return (
        <div className="w-full space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
            <div className="space-y-2">
                <h1 className="text-3xl font-black text-gray-900 leading-tight tracking-tight">Admin <span className="text-indigo-600">Profile</span></h1>
                <p className="text-lg text-gray-500 font-medium">Manage your administrator account security and preferences.</p>
            </div>
            ...
            <div className="bg-white rounded-[3rem] border border-gray-100 shadow-2xl shadow-gray-200/50 overflow-hidden">
                <div className="p-8 border-b border-gray-50 bg-gray-50/10">
                    <h3 className="font-black text-xl text-gray-900 flex items-center">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="w-full pl-14 pr-6 py-4 bg-gray-50 border-2 border-transparent rounded-2xl font-bold text-base text-gray-900 outline-none focus:ring-4 ring-indigo-500/5 focus:border-indigo-100 transition-all"
